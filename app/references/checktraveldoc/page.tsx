...
const TravelDocStatus = () => {
  ...
  const fetchData = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    setLoading(true);
    try {
      const response = await fetch(`http://localhost:5001/travelDocVerify?pin=${pin}`);
          ...
          <div className="forms-container">
            <div className="signin-signup">
              <form className="sign-in-form" onSubmit={fetchData}>
                <h2 className="title">Travel <br /> Document Status</h2>
                {pinError && (
        <div className="error-message">
          ...
          <p>{pinError}</p></div> )}
                ...
                <div className="input-field">
                  ...
                  <input type="text" placeholder="Travel document Status" name="TravelDocStatus" id="TravelDocStatus" value={Descr_value || ''} readOnly style={{ width: '270px' }}  />
                </div>
              </form>
            </div>
          </div>
          <div className="panels-container">
            <div className="panel left-panel">
              <div className="content"  data-aos="fade-up">
                <h1>Check<br />Travel Document Status</h1>
                <p>To inquire about the current status of your Travel Document, please provide the required information.</p>
              </div>
            </div>
          </div>
        </div>
...
export default TravelDocStatus;
